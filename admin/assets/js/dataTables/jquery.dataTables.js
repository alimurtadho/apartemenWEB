...
(/** @lends <global> */function( $ ) {
	...
	var _api_registe$lural; // DataTable.Api.registe$lural
	 ...
	 * for their Hungarian counte$arts. The mapping is stored in a private
	...
	function _fnColumnOptions( oSettings, iCol, oOptions )
	{
		...
		if ( oOptions !== undefined && oOptions !== null )
		{
			...
			// Map camel case parameters to their Hungarian counte$arts
	...
	function _fnBuildAjax( oSettings, data, fn )
	{
		...
		_fnCallbackFire( oSettings, 'aoServe$arams', 'serve$arams', [data] );
	...
	function _fnFilterColumn ( settings, searchStr, colIdx, regex, smart, caseInsensitive )
	{
		...
		var $Search = _fnFilterCreateSearch( searchStr, regex, smart, caseInsensitive );
	...
	{
		var $Search = _fnFilterCreateSearch( input, regex, smart, caseInsensitive );
		...
		if ( input.length <= 0 ) {
			...
			for ( i=display.length-1 ; i>=0 ; i-- ) {
				if ( ! $Search.test( settings.aoData[ display[i] ]._sFilterRow ) ) {
					display.splice( i, 1 );
				}
			}
		}
	...
	DataTable = function( options )
	{
		...
		this.each(function() {
			...
			_fnCallbackReg( oSettings, 'aoServe$arams',       oInit.fnServe$arams,      'user' );
	...
	_Api.registe$lural = _api_registe$lural = function ( pluralName, singularName, val ) {
	...
	_api_registe$lural( 'tables().nodes()', 'table().node()' , function () {
	...
	_api_registe$lural( 'tables().body()', 'table().body()' , function () {
		return this.iterator( 'table', function ( ctx ) {
			return ctx.nTBody;
		} );
	} );
	...
	_api_registe$lural( 'tables().header()', 'table().header()' , function () {
		return this.iterator( 'table', function ( ctx ) {
			return ctx.nTHead;
		} );
	} );
	...
	_api_registe$lural( 'tables().footer()', 'table().footer()' , function () {
		return this.iterator( 'table', function ( ctx ) {
			return ctx.nTFoot;
		} );
	} );
	...
	_api_registe$lural( 'rows().nodes()', 'row().node()' , function () {
	...
	_api_registe$lural( 'rows().cache()', 'row().cache()', function ( type ) {
		return this.iterator( 'row', function ( settings, row ) {
	...
	_api_registe$lural( 'rows().invalidate()', 'row().invalidate()', function ( src ) {
		return this.iterator( 'row', function ( settings, row ) {
	...
	_api_registe$lural( 'rows().indexes()', 'row().index()', function () {
		return this.iterator( 'row', function ( settings, row ) {
			return row;
		} );
	} );
	...
	_api_registe$lural( 'rows().remove()', 'row().remove()', function () {
		var that = this;
	 ...
	 *
	 */
	_api_registe$lural( 'columns().header()', 'column().header()', function ( selector, opts ) {
	 ...
	 *
	 */
	_api_registe$lural( 'columns().footer()', 'column().footer()', function ( selector, opts ) {
		return this.iterator( 'column', function ( settings, column ) {
	 ...
	 *
	 */
	_api_registe$lural( 'columns().data()', 'column().data()', function () {
	...
	_api_registe$lural( 'columns().cache()', 'column().cache()', function ( type ) {
		return this.iterator( 'column-rows', function ( settings, column, i, j, rows ) {
	...
	_api_registe$lural( 'columns().nodes()', 'column().nodes()', function () {
		return this.iterator( 'column-rows', function ( settings, column, i, j, rows ) {
	...
	_api_registe$lural( 'columns().visible()', 'column().visible()', function ( vis ) {
		return this.iterator( 'column', function ( settings, column ) {
	...
	_api_registe$lural( 'columns().indexes()', 'column().index()', function ( type ) {
		return this.iterator( 'column', function ( settings, column ) {
			return type === 'visible' ?
	...
	_api_registe$lural( 'cells().nodes()', 'cell().node()', function () {
	...
	_api_registe$lural( 'cells().cache()', 'cell().cache()', function ( type ) {
	...
	_api_registe$lural( 'cells().indexes()', 'cell().index()', function () {
		return this.iterator( 'cell', function ( settings, row, column ) {
			return {
				row: row,
				column: column,
	...
	DataTable.models.oSearch = {
		...
		/**
		 * Flag to indicate if the search term should be inte$reted as a
	...
	DataTable.defaults = {
		 ...
		 *   not return anything from the function. This supersedes `fnServe$arams`
		 *   from DataTables 1.9-.
		 *
		 ...
		 *  @dtopt Callbacks
		 *  @dtopt Server-side
		 *  @name DataTable.defaults.serve$arams
		 *
		 *  @deprecated 1.10. Please use `ajax` for this functionality now.
		 */
		"fnServe$arams": null,
