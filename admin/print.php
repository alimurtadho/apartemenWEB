...
@page { margin: 0; }
	...
	?>
		<header>
			...
			<address >
				<p> Apartemen-ku,</p>
				<p>jl jagir wonokromo,<br>wonokromo<br>
				Surabaya</p>
				<p>(+62) 65 222 44 55</p>
			</address>
			<span><img alt="" src="">Apartemen-ku</span>
		</header>
		<article>
			<h1>Recipient</h1>
			<address >
		...
		<aside>
			...
			<div >
				<p align="center">Email :- info@Apartemenku.com || Web :- www.Apartemenku.com || Phone :- +94 65 222 44 55 </p>
			</div>
		</aside>
	</body>
</html>
...
$free="Free";
$nul = null;
$$sql = "UPDATE `room` SET `place`='$free',`cusid`='$nul' where `cusid`='$id'";
